    ...
    public function contenidoRSS()
    {
        ...
        if(!file_exists($this->_ficheroCache))
        {
           //Descargamos el RSS de internet
            ...
            //Almacenamos el contenido en la cache file_put_contents(fichero a guardar,donde se guarda);
            file_put_contents($this->_ficheroCache,$datos);
        }
        
        //Comprobamos la caducidad de la cache (fechamodif(archivo)+tempocache<=horaactual
        ...
        {
            //cache está activa, devolvemos el contenido del fichero cache
